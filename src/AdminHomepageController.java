...
public class AdminHomepageController {
    ...
    private void handleAccountSettings(ActionEvent event) {
        try {
            ...
            settingsController.setAdminHomepageController(this); 
    ...
    private void openAddUserPopup(ActionEvent event) { //ACC MANAGER - ADD
        try {
            ...
            addUserPopupController.setAdminHomepageController(this);
    ...
    public void loadRouteManagerData() {
        ...
        savedRoutesList.setAll(updatedList);
    ...
    private void handleRouteUpdate(ActionEvent event) { 
        ...
        boolean startOrEndChanged = !newStartPoint.equals(selectedRoute.getRoute_startpoint()) ||
                                    !newEndPoint.equals(selectedRoute.getRoute_endpoint());
        ...
        if (startOrEndChanged) {
            ...
            selectedRoute.setEstTime(newEstimatedTime);
            selectedRoute.setAlternativeRoute(newAlternativeRoutes);
        }
    ...
    private ObservableList<String> getAllLocations() {
        return FXCollections.observableArrayList(AdminService.getAllLocations());
    }
